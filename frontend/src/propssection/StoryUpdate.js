...
import {GetSingleStory, StoryCreateAction} from '../actions/storyAction'
import {toast} from 'react-toastify'
 
export default  function StorysPropsUpdate({close,userID}){
    ...
    const {error,loginstory} = useSelector((state)=> state.WriteStorySection)
     ...
     useEffect(()=>{
       ...
       dispatch(GetSingleStory(userID))
     },[error,dispatch])
